            ...
            <div style="resize: none;width: 260px;height: 637px" class="ui card">
                ...
                <div class="extra content">
                    <div class="ui tall stacked segment">
                        ...
                        <button class="fluid ui  button" type="submit">修改个人信息</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="twelve wide column ">
            <form action="publishDo" method="post">
                @csrf
                @method('POST')
                <div class="ui  list">
                    <div class="item">
                ...
                <div class="ui fluid input">
                    ...
                    <textarea name="discription" type="text" style="width: 730px;height: 80px;resize: none" placeholder="请输入一段文章描述（150字左右）"></textarea>
                </div>
                <div class="ui  divider"></div>
                <textarea id="editor" name="con"></textarea>
                <button class="fluid ui blue button" type="submit">上传</button>
            </form>
        </div>
    </div>
    <div class="ui divider"></div>
